          ...
          <div className="bg-white/80 backdrop-blur-lg border border-white/40 shadow-lg shadow-slate-200/50 rounded-2xl px-6 py-3 flex justify-between items-center relative">
            ...
            <div className="relative group">
              <Link to="/" className="text-lg font-bold text-slate-800 tracking-tight flex items-center gap-3 py-2">
                <span className="w-9 h-9 bg-slate-900 rounded-xl flex items-center justify-center text-white font-bold text-sm shadow-lg">RG</span>
              ...
              <div className="absolute top-full left-0 mt-3 w-72 bg-white/95 backdrop-blur-xl rounded-2xl shadow-2xl border border-slate-100 p-6 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 transform translate-y-2 group-hover:translate-y-0 z-50 pointer-events-none group-hover:pointer-events-auto">
                ...
                <div className="space-y-5 relative z-10">
                  <div className="flex items-center gap-4">
                    <div className="w-12 h-12 rounded-2xl bg-teal-500 flex items-center justify-center text-white font-bold text-lg shadow-inner">
                      RG
                    </div>
                    <div>
              ...
              {ROUTES.map((route, i) => {
                ...
                return (
                  ...
                  >
                    ...
                    >
                      <Icon size={24} className={isActive ? 'text-teal-400' : route.color} />
                      {route.label}
                    </Link>
                  </motion.div>
                );
