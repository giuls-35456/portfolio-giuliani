  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="absolute -bottom-8 -left-8 w-40 h-40 bg-blue-300/5 rounded-full blur-3xl -z-10"></div>
        <div className="absolute -top-8 -right-8 w-40 h-40 bg-cyan-300/5 rounded-full blur-3xl -z-10"></div>
      </motion.div>
    </motion.div>
  );
};
